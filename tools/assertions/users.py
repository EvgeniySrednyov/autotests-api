...
def assert_get_user_response(get_user_response: GetUserResponseSchema, create_user_response: CreateUserResponseSchema):
    """
    Проверяет, что ответ с данными текущего пользователя соответствует данным пользователя при создании.

    :param get_user_response: Ответ API с данными текущего пользователя.
